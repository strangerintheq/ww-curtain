...
public class ShaderProgram {
	...
	public void setVec2(String uniformName, float a, float b) {
		int uniformId = find(uniformName);
		if (uniformId > -1) gl.glUniform2f(uniformId, a, b);
	}
	public void setVec2(String uniformName, double a, double b) {
		setVec2(uniformName, (float) a, (float) b);
	}
	public void setVec2(String uniformName, float[] array) {
		if (null == array)
			return;
		setVec2(uniformName, array[0], array[1]);
	}
	...
	public void setFloat(String uniformName, double d) {
		setFloat(uniformName, (float) d);
	}
	public void setColor(String uniformName, Color color) {
		setVec3(uniformName, color.getRGBColorComponents(null));
	}
}
